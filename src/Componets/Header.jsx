...
function Header() {
  ...
  return (
    <div className="flex items-center p-3">
      <img src={logo} width={90} height={90} className="hidden md:block" />
      ...
      <div className="flex bg-black mx-5 w-full p-2 rounded-full items-center px-2">
        <HiOutlineMagnifyingGlass/>
        <input type="text" placeholder="Search Games" 
        className="bg-black w-full outline-none pl-2 items-center rounded-full"  />
      </div>
